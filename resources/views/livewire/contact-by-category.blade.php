...
<div>
    ...
    <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
        <div class="px-4 py-2">
            <input type="text" wire:model.debounce.300ms="searchName" placeholder="Search by Name"
                class="border rounded p-2 mr-2">
            <input type="text" wire:model.debounce.300ms="searchPhone" placeholder="Search by Phone"
                class="border rounded p-2 mr-2">
            <input type="text" wire:model.debounce.300ms="searchEmail" placeholder="Search by Email"
            ...
            <button wire:click="exportContacts"
                class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded ml-2">Export
                Contacts</button>
            <div class="">
                <form action="/import-contacts" method="post" enctype="multipart/form-data">
                    ...
                    <div class="">
                        ...
                        <button type="submit"
                            class="bg-blue-500 text-white font-bold p-2 rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 mt-2">Import</button>
                    </div>
                </form>
            </div>
        </div>
        <table class="min-w-full bg-white">
            <thead>
                <tr>
                    ...
                    <th class="py-2 px-4 bg-gray-200 text-gray-600 text-left text-sm uppercase font-bold">Profile Image
                    </th>
            ...
            <tbody>
                @foreach ($contacts as $contact)
                    <tr class="border-b">
                        ...
                        <td><a href="/update-profile-image/{{ $contact->id }}" class="btn btn-sm btn-primary">Update
                                Profile Image</a></td>
                        <td>
